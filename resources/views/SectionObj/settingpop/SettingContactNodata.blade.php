                                ...
                                <ul class="list-inline">
                                    <li>
                                            <li class="list-group-item">
                                                <div>姓名:
                                                    <input class="managerpage-Popup-ContentTitle" type="text" name="ContanctText" value="{{old('ContanctText')=='' ? '' :old('ContanctText')}}">
                                                </div>                   
                                            </li>
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div>連絡電話:
                                                    <input class="" type="text" name="ContanctText" value="{{old('ContanctText')==''? '':old('ContanctText')}}">
                                                </div>                   
                                            </li>
